        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a href="#technology" className="font-geist text-white hover:text-blue-500 transition-colors duration-200">
                Возможности
              </a>
              <a href="#applications" className="font-geist text-white hover:text-blue-500 transition-colors duration-200">
                Контент
              </a>
          ...
          <div className="hidden md:block">
            <Button className="bg-blue-500 hover:bg-blue-600 text-white font-geist border-0">Смотреть бесплатно</Button>
          </div>
